# Learning Graph for Token Optimization
...
This course has 475 concepts spanning LLM fundamentals, three vendor ecosystems (Anthropic Claude, OpenAI, Google Gemini),
their harness tools, the Skills system, observability, A/B testing, and the full set of token-optimization techniques.
...
- Foundational concept: Generative AI is the single root
...
- 15 categories spanning foundations, three vendor ecosystems, harnesses, Skills, observability, A/B testing, optimization techniques, RAG, routing, budgets, privacy, and capstone work
- Largest category (Logging and Observability) holds 13.7% of concepts — well under the 30% threshold
