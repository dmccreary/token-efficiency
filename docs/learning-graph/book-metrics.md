...
|---|---------|-------|--------|-------|
| 1 | Concepts | 475 | Required | Concepts from learning graph |
...
| 6 | Chapter References | 20 / 20 | Recommended | Chapters with references.md (200 references total) |
| 7 | Glossary Terms | 475 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 91 | Recommended | Questions in faq.md |
| 9 | Words | 218,454 | Required | Words across student-facing markdown |
...
| Equations | 23 | 9 | LaTeX expressions (inline and display) |
| Total Words | 218,454 | 74,088 | Words in markdown files |
| Links | 665 | 267 | Hyperlinks in markdown format |
| Equivalent Pages | 906 | 329 | Estimated pages (250 words/page + visuals) |
